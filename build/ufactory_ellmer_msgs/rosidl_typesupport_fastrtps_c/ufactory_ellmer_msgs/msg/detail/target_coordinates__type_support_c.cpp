...
#include "ufactory_ellmer_msgs/msg/detail/target_coordinates__rosidl_typesupport_fastrtps_c.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_ufactory_ellmer_msgs
...
using _TargetCoordinates__ros_msg_type = ufactory_ellmer_msgs__msg__TargetCoordinates;
...
static uint32_t _TargetCoordinates__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ufactory_ellmer_msgs__msg__TargetCoordinates(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ufactory_ellmer_msgs__msg__TargetCoordinates;
    is_plain =
      (
...
static size_t _TargetCoordinates__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ufactory_ellmer_msgs__msg__TargetCoordinates(
