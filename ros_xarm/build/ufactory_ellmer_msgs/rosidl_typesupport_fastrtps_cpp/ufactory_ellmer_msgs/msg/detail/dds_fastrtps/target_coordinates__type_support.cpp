...
#include "ufactory_ellmer_msgs/msg/detail/target_coordinates__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ufactory_ellmer_msgs::msg::TargetCoordinates;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ufactory_ellmer_msgs::msg::TargetCoordinates *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ufactory_ellmer_msgs::msg::TargetCoordinates *>(
    untyped_ros_message);
...
{
  return &ufactory_ellmer_msgs::msg::typesupport_fastrtps_cpp::_TargetCoordinates__handle;
}
