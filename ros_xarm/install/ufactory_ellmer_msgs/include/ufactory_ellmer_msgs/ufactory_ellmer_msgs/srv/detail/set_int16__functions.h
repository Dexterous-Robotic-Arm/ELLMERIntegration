...
#ifndef UFACTORY_ELLMER_MSGS__SRV__DETAIL__SET_INT16__FUNCTIONS_H_
#define UFACTORY_ELLMER_MSGS__SRV__DETAIL__SET_INT16__FUNCTIONS_H_
 ...
 * calls
 * ufactory_ellmer_msgs__srv__SetInt16_Request__init().
...
/**
 * It calls
 * ufactory_ellmer_msgs__srv__SetInt16_Request__fini()
...
/// Check for srv/SetInt16 message equality.
/**
 ...
 * ufactory_ellmer_msgs__srv__SetInt16_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * ufactory_ellmer_msgs__srv__SetInt16_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SetInt16 message array equality.
/**
...
/// Copy an array of srv/SetInt16 messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ufactory_ellmer_msgs__srv__SetInt16_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ufactory_ellmer_msgs
...
/**
 * It calls
 * ufactory_ellmer_msgs__srv__SetInt16_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ufactory_ellmer_msgs
...
/**
 * It allocates the memory for the array and calls
 * ufactory_ellmer_msgs__srv__SetInt16_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ufactory_ellmer_msgs
...
/**
 * It calls
 * ufactory_ellmer_msgs__srv__SetInt16_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // UFACTORY_ELLMER_MSGS__SRV__DETAIL__SET_INT16__FUNCTIONS_H_
